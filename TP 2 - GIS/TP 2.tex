...
\begin{figure}[H]
    ...
    \includegraphics[scale=0.6]{mapa 3 airbnb.png}
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \includegraphics[width=.8\linewidth]{bsas1 Unemp.png}  
...
\begin{subfigure}{.5\textwidth}
  ...
  \includegraphics[width=.8\linewidth]{bsas2 Unemp.png}
  \caption{AMBA}
  \label{fig:2}
\end{subfigure}
\label{fig:7}
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \includegraphics[width=.8\linewidth]{bsas4 NBI.png}  
  \caption{Provincia de Buenos Aires}
  \label{fig:8a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  % include second image
  \includegraphics[width=.8\linewidth]{bsas3 NBI.png}
  \caption{AMBA}
  \label{fig:8b}
\end{subfigure}
\label{fig:8}
