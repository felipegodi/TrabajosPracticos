...
#######################################################################
# Importamos todos los paquetes necesarios para model4c
#######################################################################
...
class Model4c(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        # Reproject layer
        #######################################################################
        # Reproyectar en ESRI:54034 que sería la representación del mundo 
        # en área igual cilíndrica del shp de países
        alg_params = {
        ...
        # Fix geometries
        #######################################################################
        # Arreglar la geometría del shapefile reproyectado
        alg_params = {
            'INPUT': outputs['ReprojectLayer']['OUTPUT'],
            'OUTPUT': parameters['Countries_fix_geo']
        }
        outputs['FixGeometries'] = processing.run('native:fixgeometries', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        results['Countries_fix_geo'] = outputs['FixGeometries']['OUTPUT']
        ...
        # Field calculator
        #######################################################################
        # Calcular el área de los países en kilómetros cuadrados
        alg_params = {
            'FIELD_LENGTH': 10,
            'FIELD_NAME': 'km2area',
            'FIELD_PRECISION': 3,
        ...
        #######################################################################
        # Guardo como csv el archivo con la áreas de cada país
        alg_params = {
            'DATASOURCE_OPTIONS': '',
            'INPUT': outputs['FieldCalculator']['OUTPUT'],
            'LAYER_NAME': '',
            'LAYER_OPTIONS': '',
            'OUTPUT': 'C:/Users/felip/Documents/UdeSA/Maestría/Herramientas computacionales/Clase 4/output/areas.csv',
